...
These are the dependencies currently used by BGKC. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/bgkcnl
Keybase  - https://keybase.io/team/bgkc/
