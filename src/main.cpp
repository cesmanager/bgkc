...
#if defined(NDEBUG)
# error "BGKC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BGKC Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BGKC also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BGKC also requires low S in sigs
