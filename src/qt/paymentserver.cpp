...
const QString BITCOIN_IPC_PREFIX("bgkc:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bgkc-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bgkc-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bgkc-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bgkc: links
...
//
// OSX-specific way of handling bgkc: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bgkc: URIs
